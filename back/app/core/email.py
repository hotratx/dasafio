...
class EmailClient:
    ...
    async def send_confirmation_email(self, email: str, secret_string: str) -> None:
        ...
        msg = f"""Welcome to <a href="{self._base_url}">{self._site}</a>!<br /><br /><a href="{self._base_url}/confirm/{secret_string}">Click here</a> to complete your sing up<br /><br />Thanks,<br />{self._site} team"""
